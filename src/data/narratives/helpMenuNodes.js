...
const helpMenuNodes = {
  start: new NarrativeNode(
    "start",
    "Welcome to the tutorial! This is a hurricane survival simulator, where your choices will define"+
  ...
  node1: new NarrativeNode(
    "node1",
    "In this game, you have limited time to prepare before the disaster strikes."+
 ...
 node7: new NarrativeNode(
    "node7",
    "Once you are back to the main menu you can click on scoreboad and check your best score along with your last 5 scores."+
...
node9: new NarrativeNode(
    "node9",
    "That's all for the tutorial! Good luck and stay safe!",
    null,
    [
