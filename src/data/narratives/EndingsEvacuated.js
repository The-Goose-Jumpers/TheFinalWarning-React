...
export const goodEndGasSation= new NarrativeNode( //evacuate safely
    "goodend1",
    "Even after all the inconviniences you were able find shelter inside the gas station and you are now in a safe place."+
    " Despite the damage caused by the hurricane, you are safe your loved ones are safe,"+
    Scenes.GasStation,
    []
  );
